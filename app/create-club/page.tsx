...
export default function CreateClubPage() {
  ...
  const _updateTeamInvite = (id: string, field: keyof TeamInvite, value: string) => {
    setFormData(prev => ({
      ...prev,
                  ...
                  {isAuthenticated && user ? (
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex gap-3">
                        <button type="button" className="form-button-primary">Log in</button>
                        <button type="button" className="form-button-secondary">Create account</button>
                      </div>
                    </div>
                  )}
                </div>
