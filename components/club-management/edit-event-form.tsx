        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="price_member" type="number" min={0} step="0.01" value={formData.price_member ?? ''} onChange={(e) => handleInput("price_member", e.target.value === '' ? undefined : Number(e.target.value))} />
            </div>
            <div className="space-y-2">
